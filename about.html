...
<body>
  ...
  <nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-center" style="display:none" id="mySidebar">
    ...
    <a href="code.html" class="w3-bar-item w3-button">Code Files</a>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-top">
      ...
      <div class="w3-padding">
        ...
        <p>Go to This
          <a class="w3-btn" href="w3schools.com/w3css/default.asp">W3.CSS Tutorial</a>to learn more!</p>
      </div>
  ...
  <div class="w3-container">
    <div class="w3-light-grey">
      <div id="myBar" class="w3-container w3-theme w3-padding" style="width:1%"></div>
    </div>
    <br>
  ...
  <div class="w3-content" style="max-width:800px;position:relative">
    <img class="mySlides w3-animate-opacity" src="https://www.w3schools.com/w3images/snow.jpg" style="width:100%">
    <img class="mySlides w3-animate-opacity" src="https://www.w3schools.com/w3images/lights.jpg" style="width:100%">
    <img class="mySlides w3-animate-opacity" src="https://www.w3schools.com/w3images/mountains.jpg" style="width:100%">
    <img class="mySlides w3-animate-opacity" src="https://www.w3schools.com/w3images/forest.jpg" style="width:100%">
  ...
  <div class="w3-container">
    ...
    <div class="w3-bar w3-theme">
      ...
      <div class="w3-dropdown-hover">
        <button class="w3-button w3-padding-16">Dropdown
          <i class="fa fa-caret-down"></i>
        </button>
        <div class="w3-dropdown-content w3-card-4 w3-bar-block">
          <a href="https://github.com/ProjectRazz2/projectrazz2.github.io" class="w3-bar-item w3-button">Github</a>
          <a href="https://www.google.com" class="w3-bar-item w3-button">Google</a>
          <a href="https://bing.com" class="w3-bar-item w3-button">Bing</a>
        </div>
      </div>
    </div>
    <hr>
    ...
    <div id="Demo3" class="w3-hide w3-black">
      <div class="w3-container">
        ...
        <img src="https://www.w3schools.com/w3images/snow.jpg" style="width:30%;" class="w3-animate-zoom">
        <p>French Alps</p>
      </div>
    </div>
    <hr>
    ...
    <div class="w3-center">
      ...
      <br>
      <br>
      <a class="w3-button w3-circle w3-large w3-black">
        <i class="fa fa-plus"></i>
      </a>
      <a class="w3-button w3-circle w3-large w3-theme">
        <i class="fa fa-plus"></i>
      </a>
    ...
    <div class="w3-center">
      <div class="w3-dropdown-hover">
        <button class="w3-button w3-theme">Dropdown
          <i class="fa fa-caret-down"></i>
        </button>
  ...
  <footer class="w3-container w3-theme-dark">
    ...
    <p>Remember to check out our&nbsp;&nbsp;
      <a href="w3css_references.asp" class="w3-btn w3-theme" target="_blank">W3.CSS Reference</a>
    </p>
  </footer>
